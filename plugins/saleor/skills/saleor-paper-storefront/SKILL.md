...
Built for front-end developers and AI agents. This skill package includes:

- `AGENTS.md` for architecture overview and quick reference
- `rules/` with 11 task-specific rules (GraphQL, caching, variants, checkout, and more)
- `.agents/skills/` compatibility for installed community skills
- Consistent patterns that make AI-assisted edits predictable

Whether you are pair-programming with Cursor, Claude, or Copilot, the structure
is designed to help agents navigate and modify the codebase confidently.
