...
- `AGENTS.md` as architecture overview and quick reference for assistants
- `skills/saleor-paper-storefront/` with task-specific rules covering GraphQL, caching, variants, checkout, and more
- `.agents/skills/` for installed community skills (for example Vercel React best practices and composition patterns)
- Consistent, predictable structure that AI tools can navigate and modify confidently

Whether you are pair-programming with Cursor, Claude, or Copilot, the project is structured to help agents help you.
